...
const LatestDemoTriggaz: React.FC = () => {
  ...
  return (
    <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}
      ...
      <iframe
        ref={iframeRef}
        src="/latest/triggaz.html"
        title="Kasm Triggaz Demo"
        style={{ width: '90vw', height: '90vh', minHeight:'850px', display: 'block', border: '2px solid #ccc', borderRadius: '12px', boxShadow: '0 2px 16px rgba(0,0,0,0.12)' }}
        allowFullScreen
        tabIndex={-1}
        onLoad={() => {
...
export default LatestDemoTriggaz;
